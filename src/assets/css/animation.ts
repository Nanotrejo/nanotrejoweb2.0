...
const fadeOutFastAnimation = transition(":leave", [animate("250ms ease-in", style({ opacity: 0 }))]);
...
export const translateRightIn = trigger("translateRightIn", [translateRightInAnimation]);

const translateRightOutAnimation = transition(":leave", [
    style({ opacity: 1, transform: "translateX(0)" }),
    animate("150ms ease-in", style({ opacity: 0, transform: "translateX(-50%)" })),
]);

export const translateRightOut = trigger("translateRightOut", [translateRightOutAnimation]);
...
export const translateLeftIn = trigger("translateLeftIn", [translateLeftInAnimation]);
...
export const translateLeftOut = trigger("translateLeftOut", [translateLeftOutAnimation]);
